...
/*
 ...
 xor properties :
 even set bit ^ even set bit = even set bit
 odd set bit ^ odd set bit = even set bit
 even set bit ^ odd set bit = odd set bit
 odd set bit ^ even set bit = odd set bit
